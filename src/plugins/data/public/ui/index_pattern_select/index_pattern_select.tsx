    ...
    if (searchValue === this.state.searchValue) {
      ...
      const options = savedObjects.map((indexPatternSavedObject: SimpleSavedObject<any>) => {
        ...
        if (dataSourceReference) {
          ...
          const patternLabel = indexPatternSavedObject.attributes.displayName || indexPatternSavedObject.attributes.title;
          return {
        ...
        return {
          label: indexPatternSavedObject.attributes.displayName || indexPatternSavedObject.attributes.title,
          value: indexPatternSavedObject.id,
        };
      });
